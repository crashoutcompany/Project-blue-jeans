...
- DRIFT: admin vs non-admin cookies; empty closet without Neon; Gemini/UploadThing secrets unused for shell; landing vs signed-in redirect for non-admins; theme (system).
